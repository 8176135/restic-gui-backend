...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "restic-web-gui.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "restic-web-gui.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'restic_web_gui'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'restic_web_gui':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            env: {
                "__cargo_web_snippet_0867f5b2273d6da5a18fcbfa2f3fac147e45af7e": function($0) {
                var o = Module.STDWEB_PRIVATE.acquire_js_reference( $0 );return (o instanceof MouseEvent && o.type === "mouseover");
            },
            ...
            "__cargo_web_snippet_495783f798587e61fb6d63ca3d9dd642ded04893": function($0) {
                var o = Module.STDWEB_PRIVATE.acquire_js_reference( $0 );return (o instanceof MouseEvent && o.type === "mouseout");
            },
